...
class BankChainTest {
    ...
    public void testInvalidLogIn() {
        try {
            ...
            pause(2);
            assertEquals("Please enter your login credentials", driver.findElement(By.xpath("//div[@id='loginScreen']/div/div[2]/h3")).getText());
            assertEquals("Username", driver.findElement(By.xpath("//div[@id='loginScreen']/div[4]/div[2]/form/div/label")).getText());
            assertEquals("Password", driver.findElement(By.xpath("//div[@id='loginScreen']/div[4]/div[2]/form/div[2]/label")).getText());
            driver.findElement(By.id("loginUsername")).click();
            ...
            assertEquals("Unknown Username or Password", driver.findElement(By.xpath("//div[@id='loginAlert']/span")).getText());
    ...
    private void testInvalidRegister() {
        try {
            ...
            assertEquals("Welcome to BankChain", driver.findElement(By.xpath("//div[@id='registerScreen']/div/div[2]/h3")).getText());
            assertEquals("Please fill out our registration form", driver.findElement(By.xpath("//div[@id='registerScreen']/div[2]/div[2]/h4")).getText());
            assertEquals("Username", driver.findElement(By.xpath("//div[@id='registerScreen']/div[5]/div[2]/form/div/label")).getText());
            assertEquals("Password", driver.findElement(By.xpath("//div[@id='registerScreen']/div[5]/div[2]/form/div[2]/label")).getText());
            assertEquals("Full Name", driver.findElement(By.xpath("//div[@id='registerScreen']/div[5]/div[2]/form/div[3]/label")).getText());
            assertEquals("Password Recovery Question", driver.findElement(By.xpath("//div[@id='registerScreen']/div[5]/div[2]/form/div[4]/label")).getText());
            assertEquals("Password Recovery Answer", driver.findElement(By.xpath("//div[@id='registerScreen']/div[5]/div[2]/form/div[5]/label")).getText());
            driver.findElement(By.id("registerSubmitButton")).click();
            assertEquals("Required fields are missing", driver.findElement(By.xpath("//div[@id='registerAlert']/span")).getText());
    ...
    private void testValidRegister() {
        try {
            ...
            driver.findElement(By.id("registerSubmitButton")).click();
            pause(2);
            assertEquals("Accounts Home", driver.findElement(By.xpath("//div[@id='accountsHomeScreen']/div/div[2]/h3")).getText());
    ...
    private void testValidLogin() {
        ...
        try {
            ...
            assertEquals("Last Updated", driver.findElement(By.xpath("//ul[@id='accountsList']/div/div[2]/strong")).getText());
            assertEquals("Balance", driver.findElement(By.xpath("//ul[@id='accountsList']/div/div[3]/strong")).getText());
    ...
    private void testCreateAccount() {
        try {
            ...
            assertEquals("Deposit", driver.findElement(By.xpath("//ul[@id='accountsList']/div[2]/div[4]/button")).getText());
            assertEquals("View Transactions", driver.findElement(By.xpath("//ul[@id='accountsList']/div[2]/div[5]/button")).getText());
            driver.findElement(By.xpath("//ul[@id='accountsList']/div[2]/div[5]/button")).click();
            assertEquals("Post DateTypeAmount", driver.findElement(By.xpath("//div[@id='transactionsModal']/div/div/div[2]")).getText());
